"""
Event-driven Win32 clipboard monitor for ClipStory.
...
from clipstory.monitor.privacy import apply_privacy_filter
from clipstory.monitor.session import SessionManager
...
class ClipboardMonitor(threading.Thread):
    ...
    def run(self) -> None:
        ...
        wc.lpszClassName = "ClipStoryListener"
...
def _fetch_page_title(url: str) -> str | None:
    ...
    try:
        resp = requests.get(url, timeout=5, headers={"User-Agent": "ClipStory/1.0"})
